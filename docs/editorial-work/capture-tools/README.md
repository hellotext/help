...
Add `--hide-cursor` when the pointer does not explain a control or would cover a value. The default retains the visible pointer for captures where it is useful.
