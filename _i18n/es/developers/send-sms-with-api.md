...
Si quieres usar tu propio dominio para enlaces cortos, consulta la guía de [dominio personalizado para enlaces cortos]({% link _integrations/custom-domain-for-short-links.md %}).
