Puedes contactar al equipo de soporte mediante [hellotext.com/contact](https://www.hellotext.com/contact/) o escribiendo a [support@hellotext.com](mailto:support@hellotext.com).
...
1. Reproduce el problema una vez y anota la etapa exacta donde ocurre.
...
| **API o Hellotext.js** | Endpoint o evento, hora, ID de solicitud, código de respuesta y fragmento mínimo que reproduce el problema. |
