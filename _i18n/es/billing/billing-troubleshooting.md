Empieza en **Configuración → Facturación** y selecciona el mismo período que aparece en la factura o registro de pago.

## El monto es mayor de lo esperado

Revisa estos elementos por separado:

1. Confirma el plan y acuerdo activos durante el período.
2. Revisa el resumen de consumos e identifica el monto mayor de Hellotext.
...
Las facturas aparecen cuando están disponibles para un período de facturación. Revisa el selector de año y mes en **Facturas** y confirma que el período haya terminado.
...
- Agrega otro método cuando esté disponible **Nuevo método de pago**.
...
Abre la tarjeta del plan actual y busca un aviso de cambio programado y su fecha efectiva. Los cambios a planes superiores e inferiores pueden tener fechas efectivas diferentes.
...
Abre **Datos de facturación** y verifica el país del negocio y los datos fiscales. Cambiar el país puede afectar el tratamiento de impuestos, la moneda y los métodos de pago disponibles.
