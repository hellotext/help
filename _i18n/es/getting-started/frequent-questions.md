...
Si estás configurando Hellotext por primera vez, empieza por el [checklist de lanzamiento]({% link _getting-started/launch-checklist.md %}).
...
Sigue leyendo: [Resumen de audiencia y segmentación]({% link _audience/audience-overview.md %}).
...
- [Precios de Hellotext](https://www.hellotext.com/precios)

## ¿También pago Meta por WhatsApp?
...
- [Modelo de precios]({% link _billing/how-pricing-works.md %})
- [Precios de Meta para WhatsApp](https://business.whatsapp.com/products/platform-pricing#rates)
...
Sigue leyendo: [Resumen de desarrolladores y API]({% link _developers/developers-overview.md %}).

## ¿Dónde puedo pedir ayuda?

Si no sabes qué guía aplica, empieza por el [checklist de solución de problemas]({% link _troubleshooting-deliverability/troubleshooting-checklist.md %}) o contacta a soporte de Hellotext con el nombre del negocio, perfil de cliente o campaña afectada, canal, hora aproximada y qué esperabas que ocurriera.
