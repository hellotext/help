...
Hellotext opera en los canales donde tus clientes ya están: WhatsApp, Instagram Direct, Facebook Messenger, Webchat, Mercado Libre y SMS.
...
## ¿Puedo mantener control manual sobre lo que hace la IA?
...
En la práctica, sí. Mientras el valor de tu plan, el fee por desempeño o el costo de SMS supere el costo variable de mensajes, no se cobra extra.
...
* **Pro (US $ 699/mes):** pensado para retail, ERP y equipos con operación avanzada.
* **Enterprise:** plan personalizado con soporte 24/7.

El fee de desempeño disminuye a medida que tus ventas aumentan (5 % → 4 % → 3 % → 2,5 %; Enterprise desde 2 %).
...
Hellotext se conecta fácilmente con tu eCommerce, CRM y herramientas logísticas.
