...
- **[Impulsor de Primera Compra]({% link _journeys/first-purchase-driver-playbook.md %}):** convierte nuevos suscriptores o registros en compradores por primera vez.
...
Empieza acá cuando ya tienes historial de compra y quieres que los clientes compren de nuevo, compren más o sigan activos.
...
Empieza acá cuando el objetivo es responder preguntas, reducir trabajo repetitivo de soporte o mejorar la experiencia post-compra.
...
## Construir un flujo a medida

Empieza acá cuando ninguna misión preconstruida encaja con tu proceso exacto.
...
Si no sabes por dónde empezar, elige la misión que coincide con el primer cuello de botella.

| Si el cuello de botella es... | Empieza con... |
| --- | --- |
| No tienes suficientes clientes alcanzables | [Impulsor de Suscriptores]({% link _captures/subscriber-booster-playbook.md %}), códigos QR, formularios o popups del sitio, links compartibles o [Widget de Webchat]({% link _captures/webchat-widget-playbook.md %}) |
| A los perfiles les faltan propiedades útiles | [Recolector de Propiedades]({% link _captures/property-collector-playbook.md %}) |
