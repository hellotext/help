...
| Impulsar recompra | [Impulsor de Recompra]({% link _journeys/replenishment-driver-playbook.md %}), venta cruzada, cumpleaños, aniversario o reactivación suave | Necesitan suficiente historial de compras o datos de perfil para que el timing y la recomendación sean útiles. |
