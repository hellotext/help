...
Hellotext revisa si la misión tiene una razón para actuar, si el perfil del cliente puede ser contactado, si un canal puede llevar el mensaje, si aplican límites de frecuencia o timing, y si el mejor resultado es enviar, esperar, omitir o derivar.
...
La misión debe estar habilitada antes de aceptar nuevos clientes o conversaciones elegibles.
...
Si la misión está deshabilitada, no debería aceptar nueva actividad. Conversaciones, rutas o candidatos de envío que ya existían pueden necesitar tiempo para terminar según el tipo de misión.
...
- La misión necesita una ventana de conversación activa y esa ventana no está disponible.
...
Si hay varios canales disponibles, la misión puede preferir el canal que mejor encaje con la conversación y el formato del mensaje. Si no hay un canal elegible, la misión no puede enviar.

### 5. ¿Esto enviaría demasiados mensajes al cliente?

Algunas misiones aplican chequeos de frecuencia y supresión antes de enviar.

Hellotext puede detener un intento proactivo cuando:

- La misma misión ya contactó a este perfil del cliente demasiado recientemente.
- El perfil del cliente ya recibió demasiada actividad proactiva del negocio en la ventana actual.
- Otra campaña, ruta o misión ya generó suficiente presión de contacto.
- El cliente compró recientemente el producto o familia de productos que la misión iba a recuperar o recomendar.

Por eso una misión activa puede omitir un cliente específico aunque la señal exista. El sistema intenta evitar mensajes duplicados, vencidos o molestos.

### 6. ¿Es un horario permitido para enviar?

Algunas misiones pueden esperar un mejor momento de envío en lugar de enviar inmediatamente.
...
Si todos los horarios posibles están bloqueados, la misión puede omitir. Si un horario posterior es mejor y está permitido, la misión puede esperar.
...
Cuando esto pasa, revisa la configuración de la misión, el resultado del Playground, la conversación del Inbox y los reportes para ver qué parte del camino falló.
...
| ¿Ya ocurrió otro envío? | Timeline del Inbox, actividad de campañas, actividad de rutas y reportes de misiones. |
| ¿El timing demoró el envío? | Horarios silenciosos, zona horaria del negocio y timestamps de la primera actividad. |
| ¿La misión derivó? | Asignación en Inbox, equipo dueño y notas de la conversación. |
