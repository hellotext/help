...
- **[Configuración de Webchat]({% link _captures/webchat-widget-playbook.md %})**, para apariencia, comportamiento, secuencia, teaser y derivación cuando el playbook es un webchat.
