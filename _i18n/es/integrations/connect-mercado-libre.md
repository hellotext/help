Si ya estás vendiendo en Mercado Libre, puedes conectar fácilmente tu cuenta de Mercado Libre y aprovechar varios beneficios.
...
* Crear automáticamente perfiles de cliente, incluyendo detalles como números de teléfono, para seguimiento, segmentación y reportes.
* Gestionar todas las comunicaciones post-venta desde la bandeja de entrada.
* Enviar seguimientos post-venta usando plantillas de rutas o playbooks preconstruidos.
* Gestionar las notas de ventas concretadas directamente desde Hellotext.

Si eres una empresa que vende en múltiples canales, conectar tu cuenta de Mercado Libre te ayuda a mantener los perfiles de cliente en un solo lugar, con un historial completo de compras anteriores. Ese historial se vuelve información útil para segmentación, playbooks, rutas, campañas y atribución.
