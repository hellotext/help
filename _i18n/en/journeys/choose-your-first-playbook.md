...
| Drive repeat purchases | [Replenishment Driver]({% link _journeys/replenishment-driver-playbook.md %}), cross-sell, birthday, anniversary, or soft reactivation playbook | These need enough purchase history or profile data to make the timing and recommendation useful. |
