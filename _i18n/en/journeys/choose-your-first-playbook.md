...
| Drive repeat purchases or relationship moments | [Cross-Sell Driver]({% link _journeys/cross-sell-driver-playbook.md %}), [Replenishment Driver]({% link _journeys/replenishment-driver-playbook.md %}), [Birthday Bash]({% link _journeys/birthday-bash-playbook.md %}), [Soft Reactivation]({% link _journeys/soft-reactivation-playbook.md %}), or anniversary playbook | These need enough purchase history, product data, or profile data to make the timing and recommendation useful. |
