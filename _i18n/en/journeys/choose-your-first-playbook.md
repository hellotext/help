...
| --- | --- | --- |
| Grow your reachable audience or website conversations | A capture such as [Webchat Widget]({% link _captures/webchat-widget-playbook.md %}), QR code, shareable link, form, or popup | You need customers to opt in or start a conversation before many playbooks, routes, or campaigns can perform well. |
