...
| Drive repeat purchases | [Cross-Sell Driver]({% link _journeys/cross-sell-driver-playbook.md %}), [Replenishment Driver]({% link _journeys/replenishment-driver-playbook.md %}), [Soft Reactivation]({% link _journeys/soft-reactivation-playbook.md %}), birthday, or anniversary playbook | These need enough purchase history or profile data to make the timing and recommendation useful. |
| Win back inactive customers | [Dormant Revival]({% link _journeys/dormant-revival-playbook.md %}) or Sunset Saver when available | Use Dormant Revival around 3 months of inactivity. Use Sunset Saver around 12 months inactive or not reactivated. |
