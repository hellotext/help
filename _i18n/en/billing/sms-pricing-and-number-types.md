...
The sender available to a business depends on the country and account setup. Hellotext can send through approved senders or shared short codes where supported.

An exclusive short code is dedicated to one business and is intended for higher-volume or dedicated-sender requirements. It can require a separate commercial agreement and provisioning process.

See [Exclusive short codes]({% link _numbers/exclusive-short-codes.md %}) for operational details. Availability and current commercial conditions must be confirmed with Hellotext for the target country.

## Before estimating an SMS campaign
