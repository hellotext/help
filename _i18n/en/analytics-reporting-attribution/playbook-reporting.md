...
Use a playbook-specific report when the playbook collects its own outcome, such as product reviews from [Review Builder]({% link _journeys/review-builder-playbook.md %}).
