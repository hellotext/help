...
They can be embedded in your messages and used to gather analytics from campaigns, journeys, and conversations.
...
to the URL. This identifier is used to identify the session and can be used to track actions performed by the customer.
